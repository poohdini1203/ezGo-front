...
Page({
  ...
  onLoad(option){
    ...
    let that=this
    that.setData({
      driverTripID:option.driverTripID
    })
    that.set_date();
    
  },
  onShow(){
    this.getPassengerTripsByCondition().then(res=>{
      console.log(res);
       this.setData({
  ...
  toDetail(e){
    ...
    wx.navigateTo({
      url: '../passengerTripDetail/passengerTripDetail?tripID='+tripID+'&driverTripID='+this.data.driverTripID,
      success: (result)=>{
...
suggestion:function(keyword){
  ...
  formsubmit(e){
    ...
    that.getPassengerTripsByCondition().then(res=>{
      console.log(res);
      that.setData({
        passengerTrips:res.data.passengerTrips
      })
  ...
  getPassengerTripsByCondition(){
    ...
    return new Promise((resolve,reject)=>{
      wx.request({
        url:app.globalData.IP+'/passengerTrip/getTripsByCondition',
        data:{
          date:departTime,
          departure:departure,
